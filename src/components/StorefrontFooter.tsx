        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3 group mb-6">
              <img src="/brand/logos/logo-hollow.png" alt="20-July Shop" className="h-12 w-auto object-contain brightness-0 invert group-hover:opacity-80 transition-opacity" />
              <div className="flex flex-col">
                <span className="font-heading text-xl tracking-widest text-white group-hover:text-brand-pink-400 transition-colors leading-none">
                  20-July
                </span>
            ...
            <ul className="space-y-3 text-sm font-light text-brand-offwhite/60">
              <li>
                <a href="https://t.me/SreynuthTheara02" target="_blank" rel="noopener noreferrer" className="hover:text-brand-pink-400 transition-colors inline-flex items-center gap-2 group">
                  <span className="w-0 h-px bg-brand-pink-400 group-hover:w-3 transition-all duration-300"></span> Telegram
                </a>
              </li>
              <li>
