      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <table className="w-full text-left border-collapse min-w-[400px]">
              <thead>
                <tr className="bg-brand-pink-50/30 text-brand-charcoal/50 text-[9px] sm:text-xs font-bold uppercase tracking-widest border-b border-brand-pink-50/50">
                  <th className="px-2 sm:px-6 py-2 sm:py-5">{t('TableCategory')}</th>
                  <th className="px-2 sm:px-6 py-2 sm:py-5">{t('TableSlug')}</th>
                  <th className="px-2 sm:px-6 py-2 sm:py-5 hidden sm:table-cell">{t('TableDescription')}</th>
                  <th className="px-2 sm:px-6 py-2 sm:py-5 text-right">{t('TableActions')}</th>
                </tr>
              </thead>
              <tbody>
                {categories.length === 0 ? (
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-sm border border-white h-fit">
          <div className="flex items-center gap-1.5 sm:gap-3 mb-3 sm:mb-6">
            ...
            <h2 className="font-heading text-lg sm:text-2xl text-brand-charcoal">{t('NewCategory')}</h2>
          </div>
