      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-10 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <div className="bg-white p-4 sm:p-8 md:p-10 rounded-xl sm:rounded-[2rem] shadow-sm border border-brand-pink-50 h-full">
              <h3 className="font-heading text-xl sm:text-3xl text-brand-charcoal mb-4 sm:mb-8">Contact Information</h3>
              ...
              <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-12">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <p className="text-[9px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase mb-0.5 sm:mb-1">Call Us / WhatsApp</p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <p className="text-[9px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase mb-0.5 sm:mb-1">Email Us</p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <p className="text-[9px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase mb-0.5 sm:mb-1">Telegram Chat</p>
              ...
              <h3 className="font-heading text-lg sm:text-2xl text-brand-charcoal mb-3 sm:mb-6 border-t border-brand-pink-50 pt-4 sm:pt-8">Social Channels</h3>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-4 sm:p-8 md:p-12 rounded-xl sm:rounded-[2rem] shadow-xl shadow-brand-pink-100/50 border border-brand-pink-100 h-full flex flex-col justify-center">
              {status.type === 'success' ? (
                ...
                <>
                  <h3 className="font-heading text-xl sm:text-3xl text-brand-charcoal mb-2">Send a Message</h3>
                  <p className="text-xs sm:text-base text-brand-charcoal/60 font-light mb-4 sm:mb-8">We aim to respond to all inquiries within 24 hours.</p>
                  ...
                  <form className="space-y-4 sm:space-y-6" action={handleAction}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-1.5 sm:space-y-2">
                        <label htmlFor="name" className="text-[10px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase">Full Name</label>
                        <input 
                          type="text" 
                          id="name" 
                          name="name"
                      ...
                      <div className="space-y-1.5 sm:space-y-2">
                        <label htmlFor="email" className="text-[10px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase">Email Address</label>
                        <input 
                          type="email" 
                          id="email" 
                          name="email"
                    ...
                    <div className="space-y-1.5 sm:space-y-2">
                      <label htmlFor="subject" className="text-[10px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase">Subject</label>
                    ...
                    <div className="space-y-1.5 sm:space-y-2">
                      <label htmlFor="message" className="text-[10px] sm:text-sm font-bold tracking-widest text-brand-charcoal uppercase">Message</label>
                      <textarea 
                        id="message" 
                        name="message"
                        required
        ...
        <div className="mt-10 sm:mt-32 max-w-3xl mx-auto px-1">
          <div className="text-center mb-6 sm:mb-12">
            <h2 className="font-heading text-xl sm:text-4xl text-brand-charcoal mb-2 sm:mb-4">Frequently Asked Questions</h2>
            <p className="text-brand-charcoal/60 font-light text-xs sm:text-lg">Quick answers to questions you may have.</p>
          </div>
